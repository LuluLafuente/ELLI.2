    ...
    <div class="forms-container">
      <div class="signin-signup">
        <form action="login_validar.php" method="post" class="sign-in-form">
          <h2 class="title">¡Bienvenido Alumn@!</h2>
        ...
        <form class="sign-up-form" action="https://formspree.io/f/mzbwnagk" method="POST">
          ...
          <div class="input-field">
            <i class="fas fa-user"></i>
            <input type="nombre" placeholder="Nombre" name="nombre-Recupero-Alumno" />
          </div>
          <div class="input-field">
            <i class="fa-regular fa-envelope"></i>
            <input type="email" placeholder="Correo" name="mail-Recupero-Alumno" />
          </div>
          <input type="submit" value="Recuperar Clave" class="btn solid" />
        </form>
      </div>
    </div>
