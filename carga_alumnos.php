<?php
  ...
  */
  ...
  /***************************************************************************************/
  // INICIO DE REVISIONES DE DATOS DEL NUEVO ALUMNO CON ALUMNOS YA REGISTRADOS
  /***************************************************************************************/
  ...
  if($dniBD == $dni && $yaInscripto === true){
    $errores .= "<p>Ya existe un alumno en la carrera con el DNI ingresado.</p>";
    $errores .= "<p>DNI: $dni.</p>";
    $errores .= "<p>Por favor revise los datos ingresados e intente nuevamente.</p>";
  }
  
  /***************************************************************************************/
  // FIN DE REVISIONES DE DATOS DEL NUEVO ALUMNO CON ALUMNOS YA REGISTRADOS
  /***************************************************************************************/
